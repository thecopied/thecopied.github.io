...
//production
var baseURL = "https://web.archive.org/web/20121025015659/http://widget.newsinc.com/_cfvp/playlist16x9_player.html";
//test
//var baseURL = "https://web.archive.org/web/20121025015659/http://dev.assets.newsinc.com/players/flash/playlist16x9_player.html";
var baseApURL = "https://web.archive.org/web/20121025015659/http://landing.newsinc.com/apvideo/home.html";
var imageURL = "https://web.archive.org/web/20121025015659/http://assets.newsinc.com/launchers/";
var informBaseURL = "https://web.archive.org/web/20121025015659/http://videos.inform.com/relatedVideos";
...
///web.archive.org/web/20121025015659/http://for the streaming bumber assignment and config
var streamVideoId;
...
if (navigator.userAgent.match(/(iphone|ipod|ipad)/i)){
	...
	isMobile = true;	
	//production
	baseURL = "https://web.archive.org/web/20121025015659/http://widget.newsinc.com/_mob/16x9/player.html";
	//test
	//baseURL = "https://web.archive.org/web/20121025015659/http://dev.assets.newsinc.com/players/mobile/16x9/player.html";
}
...
var sendToActionScript = function () {
	...
	//thisMovie("ndn_adbox").sendToActionScript(50860,"23579178","10557","david_test2","994","2375","https://web.archive.org/web/20121025015659/http://www.newsinc.com","https://web.archive.org/web/20121025015659/http://video.newsinc.com/23579178.flv","testDistributor","testProvider","testProviderCat");
	//thisMovie("ndn_adbox").sendToActionScript(ZoneID,"23605024",freewheel,sitesection,cid,wid,landingURL,"https://web.archive.org/web/20121025015659/http://video.newsinc.com/bumper/bumperNDN.f4v");
	//thisMovie("ndn_adbox").sendToActionScript(ZoneID,"23408962",freewheel,sitesection,cid,wid,landingURL,"https://web.archive.org/web/20121025015659/http://video.newsinc.com/bumper/bumperNDN.f4v");
	/*TESTING null var junk;
	thisMovie("ndn_adbox").sendToActionScript(ZoneID,junk,freewheel,
	sitesection,cid,wid,landingURL,"https://web.archive.org/web/20121025015659/http://video.newsinc.com/bumper/bumperNDN.f4v",
...
constructPlaylist = function (){
	...
	if(isInform == false){
		//prod
		$.GetDataFromURL('https://web.archive.org/web/20121025015659/http://lt.ndnps.newsinc.com/playlistcontents/show/'+freewheel+'/'+wid+'/' + playlistArr[activePlaylist].playlistid + '/0/' + did,playlistServices);
		//dev http://dev.mps.newsinc.com/
		//$.GetDataFromURL('https://web.archive.org/web/20121025015659/http://dev.mps.newsinc.com/playlistcontents/show/'+freewheel+'/'+wid+'/' + playlistArr[activePlaylist].playlistid + '/0/' + did,playlistServices);
	}else{
		var service_url;
...
getPlaylist = function (){
	...
	if(isInform == false){
	//production
	$.GetDataFromURL('https://web.archive.org/web/20121025015659/http://lt.ndnps.newsinc.com/playlistcontents/show/'+freewheel+'/'+wid+'/' + cid + '/0/' + did,playlistServices);
	//dev
	//$.GetDataFromURL('https://web.archive.org/web/20121025015659/http://dev.mps.newsinc.com/playlistcontents/show/'+freewheel+'/'+wid+'/' + cid + '/0/' + did,playlistServices);
	}else{
		//alert("Inform TRUE");
		var service_url;
		var newsArticleURL = informArticleUrl;
...
constructContents = function (ci){
	...
	contentCnt = 0;
	//production
	$.GetDataFromURL('https://web.archive.org/web/20121025015659/http://lt.ndnps.newsinc.com/content/show/0'+'/0/'+ ci + '/' + did,contentServices);
	//dev
	//$.GetDataFromURL('https://web.archive.org/web/20121025015659/http://dev.mps.newsinc.com/content/show/0'+'/0/'+ ci + '/' + did,contentServices);
}
...
loadThumbs = function (){
	...
	div.src = 'https://web.archive.org/web/20121025015659/http://ad.crwdcntrl.net/5/to=y/p=3046';
	 document.body.appendChild(div);
	//production
	$.GetDataFromURL('https://web.archive.org/web/20121025015659/http://lt.ndnps.newsinc.com/launcher/show/'+freewheel+'/'+wid+'/'+cid+'/'+did, thumbServices);
	//dev http://dev.mps.newsinc.com/
	//$.GetDataFromURL('https://web.archive.org/web/20121025015659/http://dev.mps.newsinc.com/launcher/show/'+freewheel+'/'+wid+'/'+cid+'/'+did, thumbServices);
	rdm = String(Math.floor(Math.random()*1000000000));
	GAC = GetAnalyticsUserToken();
	if (GAC == null){
		GAC = SetAnalyticsCookie();
	}
	analyticsString = String("https://web.archive.org/web/20121025015659/http://sana.newsinc.com/sana.html?wid="+wid+"&uut="+GAC+"&furl="+furl+"&purl=&ssid="+sitesection+"&anid="+freewheel+"&ltype="+ltype+"&plid="+cid+"&device="+did+"&rdm="+rdm);
...
(document.location.protocol == "https:" ? "https://web.archive.org/web/20121025015659/https://sb" : "http://b") +
...
/*
     FILE ARCHIVED ON 01:56:59 Oct 25, 2012 AND RETRIEVED FROM THE
...
playback timings (ms):
  ...
  esindex: 0.01
  cdx.remote: 17.237
  LoadShardBlock: 146.377 (3)
  PetaboxLoader3.datanode: 135.975 (5)
  PetaboxLoader3.resolve: 193.274 (3)
  load_resource: 213.25 (2)
*/