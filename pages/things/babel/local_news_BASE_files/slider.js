...
function sliderInit() {
	...
	if(sliderContainer.length) {
		var	sliderHeight = sliderContainer[0].offsetHeight;
		var sliderArrows = document.getElementsByClassName("arrow");
		sliderHeight = (sliderHeight - 41) / 2;
		for (i=0; i<sliderArrows.length; i++) {
			sliderArrows[i].style.top = sliderHeight+"px";
		};
	}
}
...
playback timings (ms):
  ...
  esindex: 0.012
  cdx.remote: 13.193
  LoadShardBlock: 93.815 (3)
  PetaboxLoader3.datanode: 77.865 (4)
  PetaboxLoader3.resolve: 95.346 (2)
  load_resource: 101.502
*/